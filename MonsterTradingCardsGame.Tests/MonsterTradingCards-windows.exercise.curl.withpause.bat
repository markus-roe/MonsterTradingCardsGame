...
REM --------------------------------------------------
echo Mandatory Feature 2: Merge Cards (merge two random cards and if they are different element type, creates a new one, removes random old card, costs 3 coins)
